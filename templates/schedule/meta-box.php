			...
			<div class="queuewp-selector">
				<div class="queuewp-accounts">
					<ul>
						...
						?>
						<li>
							<input name="queuewp-accounts" type="checkbox" value="<?php echo esc_attr( $account ); ?>"><span class="dashicons <?php echo esc_attr( $account_data['icon'] ); ?>"></span>
						</li>
						<?php
							endforeach;
						endif;
						?>
						<li>
							<input name="queuewp-accounts" type="checkbox"><span class="dashicons dashicons-twitter"></span>
						</li>
						<li>
							<input name="queuewp-accounts" type="checkbox"><span class="dashicons dashicons-facebook"></span>
						</li>
					</ul>
				</div>
